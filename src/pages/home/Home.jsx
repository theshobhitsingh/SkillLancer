    ...
    return ([
        <div className="home">
            ...
            <div className="features dark">
                <div className="container">
                    <div className="item">
                        <h1>SkillLancer <span style={{ fontWeight: '300' }}>business.</span></h1>
                        ...
                        <button>Explore SkillLancer Business</button>
                    </div>
                    <div className="item">
            ...
            <div className="logo_maker">
                <div className="items">
                    <div className="left">
                        <h1>SkillLancer <span>logomaker.</span></h1>
                        ...
                        <button className="logo_button"><strong>Try SkillLancer Logo Maker</strong></button>
                    </div>
                    <div className="right">
            ...
            <div className="secondslide">
                <p className="second_slider_heading">Inspiring work made on SkillLancer</p>
            ...
            <div className="last_hero">
                <div className="items">
                    <div className="left">
                        <h1>Suddenly everything is <em><span className="last_hero_em">possible.</span></em></h1>
                        <button onClick={e => navigate(`/register`)}>Join SkillLancer</button>
                    </div>
                    <div className="right">
