            ...
            <div className="container">
                ...
                <div className="item2">
                    <div className="header_item2">
                        <h1>What makes a successful SkillLancer profile?</h1>
                        <p>Your first impression matters! Create a profile that will stand out from the crowd on SkillLancer.com</p>
                    </div>
                    <div className="title">
                        <div className="item">
