            ...
            <div className="container">
                <div className="logo">
                    <Link to='/' className='link'>
                        <span className='log'>SkillLancer</span>
                    </Link>
                ...
                <div className="links">
                    <span onClick={()=>navigate('/becomeseller')}></span>
                    <span className="tooltip ">Explore
                        <span className="tooltiptext">
                           /* <div className="col">
                                <div className="item_tooltip">
                                    <h4 className='item_tooltip_header'></h4>
                                    <p className='item_tooltip_desc'></p>
                                </div>
                                <div className="item_tooltip">
                                    <h4 className='item_tooltip_header'></h4>
                            ...
                            <div className="col">
                                <div className="item_tooltip">
                                    <h4 className='item_tooltip_header'></h4>
                                    <p className='item_tooltip_desc'>Connect with Our team and community</p>
                                </div>
                                <div className="item_tooltip">
                                    <h4 className='item_tooltip_header'></h4>
                                    <p className='item_tooltip_desc'>Inside tips from top business minds</p>
                                ...
                                <div className="item_tooltip">
                                    <h4 className='item_tooltip_header'>Platform Workspace</h4>
                    ...
                    <Link to='/login' className='link' key={333}><span></span></Link>

                    {!current_user?.isSeller && <span onClick={e => navigate('/becomeSeller')}>Become a Freelancer</span>}
